...
#Step 1
${field_TtlStamp}                   xpath://body/ul[1]/li[2]/section[3]/ul[1]/li[1]/ul[1]/li[3]/div[1]/ul[2]/li[1]/input[1]
${field_ProdName}                   xpath://body/ul[1]/li[2]/section[3]/ul[1]/li[1]/ul[1]/li[3]/div[1]/ul[2]/li[2]/input[1]
${field_StrtDate}                   xpath://body[1]/ul[1]/li[2]/section[3]/ul[1]/li[1]/ul[1]/li[3]/div[1]/ul[2]/li[3]/input[1]
${field_EndDate}                    xpath://body[1]/ul[1]/li[2]/section[3]/ul[1]/li[1]/ul[1]/li[3]/div[1]/ul[2]/li[4]/input[1]
${btn_Next}                         xpath://body[1]/ul[1]/li[2]/section[4]/ul[1]/li[2]/a[1]
...
${rewardValue}                      500000
${rewardName}                       Auto_1StampPerItemPurchase
${rewardStamp}                      5
...
Select 1 Stamp per Item Purchase
    Wait Until Element is Enabled       ${rdioBtn_ItemBased}                    ${delay}
    Click Element                       ${rdioBtn_ItemBased}
    Page Should Contain Element         ${rdioBtn_ItemBased}
Input Total Number Stamp
    Wait Until Element is Enabled       ${field_TtlStamp}                       ${delay}
    Input Text                          ${field_TtlStamp}                       ${TtlStamp}
Input Product Name
    ${random}=                          Generate Random String                  3   [NUMBERS]
    Wait Until Element is Enabled       ${field_ProdName}                       ${delay}
    Input Text                          ${field_ProdName}                       ${ProdName}${random}
